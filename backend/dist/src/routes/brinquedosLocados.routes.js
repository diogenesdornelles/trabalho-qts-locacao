...
const BrinquedosLocadosController_1 = __importDefault(
  require('../controllers/BrinquedosLocadosController'),
)
...
class BrinquedosLocadosRouter extends BaseRouter_1.BaseRouter {
  ...
  initRoutes() {
    ...
    this.router.post(
      '/',
      GeneralMiddleware_1.default.authentication,
      GeneralMiddleware_1.default.authorizationAnalistaLocacao,
