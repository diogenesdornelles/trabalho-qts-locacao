...
const brinquedos_locados_controller_1 = __importDefault(
  require('../controllers/brinquedos-locados.controller'),
)
...
class BrinquedosLocadosRouter extends base_routes_1.BaseRouter {
  ...
  initRoutes() {
    ...
    this.router.post(
      '/',
      general_middleware_1.default.authentication,
      general_middleware_1.default.authorizationBrinquedosLocados,
