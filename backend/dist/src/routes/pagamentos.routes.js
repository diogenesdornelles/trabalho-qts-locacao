...
const PagamentosController_1 = __importDefault(require("../controllers/PagamentosController"));
...
class PagamentosRouter extends BaseRouter_1.BaseRouter {
    ...
    initRoutes() {
        ...
        this.router.post('/', GeneralMiddleware_1.default.authentication, GeneralMiddleware_1.default.authorizationCaixa, GeneralMiddleware_1.default.validateBodyRequest, this.controller.create, GeneralMiddleware_1.default.errorHandler);
    }
}
