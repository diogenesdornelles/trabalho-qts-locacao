...
const tipos_brinquedos_controller_1 = __importDefault(
  require('../controllers/tipos-brinquedos.controller'),
)
...
class TiposBrinquedosRouter extends base_routes_1.BaseRouter {
  ...
  initRoutes() {
    ...
    this.router.post(
      '/',
      general_middleware_1.default.authentication,
      general_middleware_1.default.authorizationTiposBrinquedos,
