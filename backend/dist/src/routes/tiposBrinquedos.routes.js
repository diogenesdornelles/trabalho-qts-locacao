...
class TiposBrinquedosRouter extends base_routes_1.BaseRouter {
    ...
    initRoutes() {
        ...
        this.router.post('/', general_middleware_1.default.authentication, general_middleware_1.default.authorizationTiposBrinquedos, general_middleware_1.default.validateBodyRequest, this.controller.create, general_middleware_1.default.errorHandler);
        this.router.put('/:cod', general_middleware_1.default.authentication, general_middleware_1.default.authorizationTiposBrinquedos, general_middleware_1.default.validateUUID, this.controller.update, general_middleware_1.default.errorHandler);
    }
}
