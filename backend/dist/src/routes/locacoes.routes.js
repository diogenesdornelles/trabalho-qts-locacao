...
const locacoes_controller_1 = __importDefault(require("../controllers/locacoes.controller"));
const general_middleware_1 = __importDefault(require("../middlewares/general.middleware"));
const base_routes_1 = require("./base.routes");
class LocacoesRouter extends base_routes_1.BaseRouter {
    constructor() {
        super(new locacoes_controller_1.default());
    }
    initRoutes() {
        ...
        this.router.post('/', general_middleware_1.default.authentication, general_middleware_1.default.authorizationLocacoes, general_middleware_1.default.validateBodyRequest, this.controller.create, general_middleware_1.default.errorHandler);
    }
}
