...
class FuncionariosRouter extends BaseRouter_1.BaseRouter {
    ...
    initRoutes() {
        ...
        this.router.get('/:cpf', GeneralMiddleware_1.default.validateCpf, this.controller.getOne, GeneralMiddleware_1.default.errorHandler);
        ...
        this.router.put('/:cpf', GeneralMiddleware_1.default.validateCpf, this.controller.update, GeneralMiddleware_1.default.errorHandler);
        this.router.delete('/:cpf', GeneralMiddleware_1.default.validateCpf, this.controller.delete, GeneralMiddleware_1.default.errorHandler);
    }
}
