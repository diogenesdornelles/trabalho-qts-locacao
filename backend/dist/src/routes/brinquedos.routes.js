...
class BrinquedosRouter extends base_routes_1.BaseRouter {
    ...
    initRoutes() {
        ...
        this.router.delete('/:cod', general_middleware_1.default.authentication, general_middleware_1.default.authorizationAlmoxarife, general_middleware_1.default.validateUUID, this.controller.delete, general_middleware_1.default.errorHandler);
    }
}
