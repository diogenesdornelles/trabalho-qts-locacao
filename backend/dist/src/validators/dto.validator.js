...
const general_validator_1 = __importDefault(require("./general.validator"));
class DTOValidator {
    constructor() {
        /*
        ...
        this.createBrinquedoLocadoSchema = zod_1.z
            .object({
            cod_locacao: zod_1.z.string().uuid('Deve informar UUID de locação válido'),
            cod_brinquedo: zod_1.z.string().uuid('Deve informar UUID de brinquedo válido'),
        })
            .strict();
        this.createClienteSchema = zod_1.z
            ...
            cpf: zod_1.z
                ...
                .refine(general_validator_1.default.validateCpf, {
            ...
            telefone: zod_1.z
                .string()
                .transform(str => str.replace(/\D/g, ''))
                .refine(general_validator_1.default.validatePhone, {
        ...
        this.createFuncionarioSchema = zod_1.z
            ...
            senha: zod_1.z.string().refine(general_validator_1.default.isValidPwd, {
                message: `
        ...
        this.createPagamentoSchema = zod_1.z
            ...
            cod_locacao: zod_1.z.string().uuid('Forneça um UUID de locação correto'),
        ...
        this.updateBrinquedoLocadoSchema = this.createBrinquedoLocadoSchema.partial();
