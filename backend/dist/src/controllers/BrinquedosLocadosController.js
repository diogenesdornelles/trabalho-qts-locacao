...
const BrinquedoLocadoServices_1 = __importDefault(
  require('../services/BrinquedoLocadoServices'),
)
  ...
  constructor() {
    ...
    this.create = (req, res, next) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const validatedData =
            CreateBrinquedoLocadoValidator_1.CreateBrinquedoLocadoValidator.parse(
              req.body,
            )
    ...
    this.update = (req, res, next) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          const { cod } = req.params
          const validatedData =
            UpdateBrinquedoLocadoValidator_1.UpdateBrinquedoLocadoValidator.parse(
              req.body,
            )
