...
const TipoBrinquedoServices_1 = __importDefault(require("../services/TipoBrinquedoServices"));
...
class TiposBrinquedosController extends BaseController_1.BaseController {
    constructor() {
        ...
        this.create = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const validatedData = CreateTipoBrinquedoValidator_1.CreateTipoBrinquedoValidator.parse(req.body);
        ...
        this.update = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { cod } = req.params;
                const validatedData = UpdateTipoBrinquedoValidator_1.UpdateTipoBrinquedoValidator.parse(req.body);
