...
const brinquedo_locado_services_1 = __importDefault(
  require('../services/brinquedo-locado.services'),
)
...
class BrinquedosLocadosController extends base_controller_1.BaseController {
  constructor() {
    super(
      new brinquedo_locado_services_1.default(),
      new dto_validator_1.default(),
    )
