...
const LocacaoServices_1 = __importDefault(require("../services/LocacaoServices"));
...
class LocacoesController extends BaseController_1.BaseController {
    constructor() {
        ...
        this.create = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const validatedData = CreateLocacaoValidator_1.CreateLocacaoValidator.parse(req.body);
