...
const funcionario_services_1 = __importDefault(require("../services/funcionario.services"));
const base_controller_1 = require("./base.controller");
const dto_validator_1 = __importDefault(require("../validators/dto.validator"));
class FuncionariosController extends base_controller_1.BaseController {
    constructor() {
        super(new funcionario_services_1.default(), new dto_validator_1.default());
        ...
        this.create = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const validatedData = this.validator.createFuncionario(req.body);
        ...
        this.update = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { cpf } = req.params;
                const validatedData = this.validator.updateFuncionario(req.body);
                const updatedFuncionario = yield this.service.update(cpf, validatedData);
