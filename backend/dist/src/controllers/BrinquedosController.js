...
const BrinquedoServices_1 = __importDefault(require("../services/BrinquedoServices"));
...
class BrinquedosController extends BaseController_1.BaseController {
    constructor() {
        ...
        this.create = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const brinquedo = yield this.service.create(req);
        ...
        this.update = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { cod } = req.params;
                const updatedBrinquedo = yield this.service.update(cod, req);
                if (!updatedBrinquedo) {
                    res.status(404).json({ message: 'Toy not found' });
                    return;
                }
