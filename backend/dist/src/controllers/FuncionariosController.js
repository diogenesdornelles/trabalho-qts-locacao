...
const FuncionarioServices_1 = __importDefault(require("../services/FuncionarioServices"));
...
class FuncionariosController extends BaseController_1.BaseController {
    constructor() {
        ...
        this.create = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const validatedData = CreateFuncionarioValidator_1.CreateFuncionarioValidator.parse(req.body);
        ...
        this.update = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { cpf } = req.params;
                const validatedData = UpdateFuncionarioValidator_1.UpdateFuncionarioValidator.parse(req.body);
