...
const brinquedo_services_1 = __importDefault(require("../services/brinquedo.services"));
const base_controller_1 = require("./base.controller");
const dto_validator_1 = __importDefault(require("../validators/dto.validator"));
class BrinquedosController extends base_controller_1.BaseController {
    constructor() {
        super(new brinquedo_services_1.default(), new dto_validator_1.default());
        ...
        this.create = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const validatedData = this.validator.createBrinquedo(req.body);
        ...
        this.update = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { cod } = req.params;
                const validatedData = this.validator.updateBrinquedo(req.body);
