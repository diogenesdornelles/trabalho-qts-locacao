...
class PagamentoServices extends base_service_1.BaseService {
    constructor() {
        ...
        this.create = (data) => __awaiter(this, void 0, void 0, function* () {
            ...
            const totalValue = yield this.locacaoService.getTotalValue(data.cod_locacao);
            // Check if the value is sufficient
            if (data.valor_pagamento < totalValue) {
                throw new api_error_util_1.ApiError(404, 'Payment value is not enought');
            }
            // Update rental payment status
            const updatedLocadao = yield this.locacaoService.update(data.cod_locacao, {
                pgto_status: 'PAGO',
            });
            if (!updatedLocadao) {
