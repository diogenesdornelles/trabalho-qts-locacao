...
const hash_pwd_util_1 = __importDefault(require("../utils/hash-pwd.util"));
class FuncionarioServices extends base_service_1.BaseService {
    constructor() {
        ...
        this.create = (data) => __awaiter(this, void 0, void 0, function* () {
            ...
            data.senha = yield (0, hash_pwd_util_1.default)(data.senha);
