...
class BrinquedoLocadoServices extends base_service_1.BaseService {
    constructor() {
        ...
        this.create = (data) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (brinquedoDB) {
                ...
                const createdBrinquedoLocado = yield this.prisma.brinquedoLocado.create({
                    data: Object.assign(Object.assign({}, data), { valor_unitario: brinquedoDB.valor_locacao, nome: brinquedoDB.nome, data_devolucao: tomorrow }),
                });
