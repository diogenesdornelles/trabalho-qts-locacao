    ...
    this.getOne = pk =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          ...
          throw new Error(
            'An unknown error occurred while fetching rented toy.',
          )
        }
      })
    this.create = data =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          ...
          if (brinquedoDB) {
            ...
            const createdBrinquedoLocado =
              yield this.prisma.brinquedoLocado.create({
          ...
          if (error instanceof zod_1.z.ZodError) {
            console.error(
              'Validation error on create rented toy:',
              error.errors,
            )
            throw new Error(
    ...
    this.update = (pk, data) =>
      __awaiter(this, void 0, void 0, function* () {
        try {
          ...
          const updatedBrinquedoLocado =
            yield this.prisma.brinquedoLocado.update({
              where: { cod: pk },
          ...
          if (error instanceof zod_1.z.ZodError) {
            console.error(
              'Validation error on update rented toy:',
              error.errors,
            )
            throw new Error(
              `Validation error: ${error.errors.map(err => err.message).join(', ')}`,
          ...
          throw new Error(
            'An unknown error occurred while updating rented toy.',
          )
        }
      })
    this.delete = pk =>
