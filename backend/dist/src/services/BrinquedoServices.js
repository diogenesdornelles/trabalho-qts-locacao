    ...
    constructor() {
        ...
        this.create = (req) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const validatedData = schemas_1.BrinquedoSchema.parse(req.body);
                // Salva o novo brinquedo utilizando o método create do Prisma
                const createdBrinquedo = yield this.prisma.brinquedo.create({
                    data: validatedData,
                });
        ...
        this.update = (pk, req) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const partialSchema = schemas_1.BrinquedoSchema.partial();
