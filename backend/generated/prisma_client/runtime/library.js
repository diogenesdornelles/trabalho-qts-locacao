  ...
  function ps(e) {
    ...
    if (e && e.path && e.path.length > 0)
      if (Array.isArray(e.path))
        for (let r of e.path)
          Ei.existsSync(r) && (t = r.endsWith('.vault') ? r : `${r}.vault`)
  ...
  toString() {
    let { config: t } = this,
      r = t.provider.fromEnvVar
        ...
        : t.provider.value,
      n = JSON.parse(
        JSON.stringify({ provider: r, binaryTargets: _c(t.binaryTargets) }),
      )
...
m.inverseTangent = m.atan = function () {
  ...
  for (
    E = !1, t = Math.ceil(a / b), n = 1, l = u.times(u), s = new c(u), i = u;
    e !== -1;
  ...
  e: if (t != null) {
    ...
    if (
      ...
      return (
        (p.length = 0),
        u
          ? ((t -= e.e + 1), (p[0] = Q(10, (b - (t % b)) % b)), (e.e = -t || 0))
          : (p[0] = e.e = 0),
        e
      )
    if (
...
function Us(e) {
  ...
  function i(o) {
    ...
    if (l === 'bigint')
      return o < 0 ? ((o = -o), (u.s = -1)) : (u.s = 1), tn(u, o.toString())
    throw Error(Ke + o)
  }
  if (
    ((i.prototype = m),
...
async function cl(e, t) {
  ...
  if (
    (gm('enginePath', n), n !== void 0 && e === 'binary' && yi(n), n !== void 0)
  )
