...
var wi = ge(Xe => {
  ...
  var ii = (e, t) => () => (
    ...
    ba = ii(e => {
      ...
      function S(C) {
        for (
          var A, O = C.length, M = O % 3, L = [], I = 16383, D = 0, $ = O - M;
          D < $;
          D += I
        )
...
var Ii,
  ...
  pn = Fe(() => {
    ...
    ;(Ii = '/'),
      (xl = { sep: Ii }),
      (Pl = { resolve: bl, posix: xl, join: El, sep: Ii }),
      (we = Pl)
  })
var _i = ge((If, vl) => {
  vl.exports = {
...
R.inverseTangent = R.atan = function () {
  ...
  for (
    F = !1, t = Math.ceil(a / _), n = 1, l = u.times(u), s = new g(u), i = u;
    e !== -1;
  ...
  e: if (t != null) {
    ...
    if (
      ...
      return (
        (h.length = 0),
        u
          ? ((t -= e.e + 1), (h[0] = W(10, (_ - (t % _)) % _)), (e.e = -t || 0))
          : (h[0] = e.e = 0),
        e
      )
    if (
...
function uo(e) {
  ...
  function i(o) {
    ...
    if (l === 'bigint')
      return o < 0 ? ((o = -o), (u.s = -1)) : (u.s = 1), lr(u, o.toString())
    throw Error($e + o)
  }
  if (
    ((i.prototype = R),
...
var Ru = e => e,
  ...
  N = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, '__id', { value: ++Su }), e.__id
        )
      },
